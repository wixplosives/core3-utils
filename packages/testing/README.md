...
- [scaleTimeout()](https://wixplosives.github.io/core3-utils/testing.scaletimeout) multiplies timeouts when debugging or running on slow CI machines, based on TIMEOUT_SCALE and DEBUG env variables
...
| [locatorTimeout(ms)](https://wixplosives.github.io/core3-utils/testing.locatortimeout)                              | Creates a playwright locator options with [scaled](https://wixplosives.github.io/core3-utils/testing.scaletimeout) timeout and adjust the current test timeout accordingly                                                                                                                                                         |
...
| [overrideTimeoutScale(scale)](https://wixplosives.github.io/core3-utils/testing.overridetimeoutscale)               | Overrides the TIMEOUT_SCALE for the current test                                                                                                                                                                                                                                                                                   |
...
| [scaleTimeout(timeout)](https://wixplosives.github.io/core3-utils/testing.scaletimeout)                             | Scales a timeout based on the TIMEOUT_SCALE and DEBUG environment variable                                                                                                                                                                                                                                                         |
