...
| [Path](https://wixplosives.github.io/core3-utils/testing.path)         | Handy predicate creators for [waitForPath](https://wixplosives.github.io/core3-utils/testing.waitforpath) |
...
| [waitForPath(fs, path, predicate)](https://wixplosives.github.io/core3-utils/testing.waitforpath)             | <p>waits for a path to satisfy the predicate</p><p>[Path](https://wixplosives.github.io/core3-utils/testing.path) as helpful predicator creators.</p>                                                                                                                                                                                                                           |
...
| ------------------------------------------------------------------------------------------ | --------------------------------- |
| [FsStep](https://wixplosives.github.io/core3-utils/testing.fsstep)                         |                                   |
...
| [FsPredicate](https://wixplosives.github.io/core3-utils/testing.fspredicate) |                                                                                                                                   |
